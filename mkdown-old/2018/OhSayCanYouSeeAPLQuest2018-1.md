...
We want to implement an API function that can calculate the number of visible buildings. We can start by defining an anonymous lambda function which will refer to our test case. But how do we compute visibility?
