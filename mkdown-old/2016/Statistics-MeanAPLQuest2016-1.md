Sure, here's your Markdown content with the APL examples incorporated at relevant sections:
...
Today's quest is the first from the 2016 round of the EPL Problem Solving Competition. We are simply to compute the mean, or arithmetic mean, the average. There are a couple of gotchas here, but for the very basic part of the problem, this is extremely simple.
...
There are some notational niceties we can do in APL as well. There's something called **tested programming** or **point-free programming**, a fancy term meaning I'm not going to mention my arguments.
...
This revision incorporates the APL examples closely related to the discussed concepts while maintaining clarity in the Markdown format.