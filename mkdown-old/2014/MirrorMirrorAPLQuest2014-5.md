Here's the revised Markdown file with the APL examples incorporated into the relevant sections:

```markdown
# Welcome to the EPL Quest CAPL Wiki

## Details

Today's quest is the fifth problem from the 2014 round of the Appeal Problem Solving Competition. The task is to determine whether a given text is a palindrome. A slight complication is that we need to ignore case differences and punctuation.
...
This version includes the APL code snippets in the appropriate sections of the documentation, making it easier for readers to understand the concepts presented.